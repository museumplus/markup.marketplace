jQuery(function(){
    ...
    $('.main-nav__item-link--catalog').hover(
        function() {
            $('.main-nav__drop--catalog .main-nav__drop-list').find('.item-hover').removeClass('item-hover');
            $('.main-nav__drop--catalog .main-nav__drop-list').find(':first-child').addClass('item-hover');
            /*
    ...
    $('.showFull').on('click', function(e) {
        ...
        if ($(this).parents('.order__item').hasClass('active')) {
            ...
            e.stopPropagation();
            $(this).parents('.order__item').addClass('load').siblings().removeClass('active load');

            $(this).parents('.order__item').delay(1000).queue(function (next) {
...
function initSlickGallery() {
    $('.main-slider__slides').slick({
        ...
        fade: true,
        arrows: true,
        nextArrow: '<a class="slider-arrow-btn--next slider-arrow-btn" href="#">Next</a>',
        prevArrow: '<a class="slider-arrow-btn--prev slider-arrow-btn" href="#">Previous</a>',
        responsive: [
            {
                breakpoint: 767,
                settings: {
    ...
    jQuery('.thumbnails-holder').slick({
        ...
        slidesToScroll: 1,
        arrows: true,
        nextArrow: '<a class="slider-arrow-btn product-info-slider-btn--next product-info-slider-btn" href="#">Next</a>',
        prevArrow: '<a class="slider-arrow-btn product-info-slider-btn--prev product-info-slider-btn" href="#">Previous</a>',
...
function initTabletMenu() {
    jQuery('body').contentPopup({
        ...
        popup: '.tablets-catalog-body-popup',
        openClass: 'tablets-catalog-body-popup-active tablets-menu-body-popup-active',
        btnClose: '.body-popup-close',
        hideOnClickOutside: false
    });
}
...
function initLazyHover(){
    ...
    jQuery('.main-nav__drop--catalog .main-nav__drop-list .main-nav__sub-item').menuAim({
        activate: function(row){
            var $row = $(row);
...
// jQuery aim
;(function(e){function t(t){var n=e(this),r=null,i=[],s=null,o=null,u=e.extend({rowSelector:"> li",submenuSelector:"*",submenuDirection:"right",tolerance:75,enter:e.noop,exit:e.noop,activate:e.noop,deactivate:e.noop,exitMenu:e.noop},t);var a=3,f=200;var l=function(e){i.push({x:e.pageX,y:e.pageY});if(i.length>a){i.shift()}};var c=function(){if(o){clearTimeout(o)}if(u.exitMenu(this)){if(r){u.deactivate(r)}r=null}};var h=function(){if(o){clearTimeout(o)}u.enter(this);m(this)},p=function(){u.exit(this)};var d=function(){v(this)};var v=function(e){if(r){u.deactivate(r)}u.activate(e);r=e};var m=function(e){var t=g();if(t){o=setTimeout(function(){m(e)},t)}else{v(e)}};var g=function(){function t(e,t){return(t.y-e.y)/(t.x-e.x)}if(!r||!e(r).is(u.submenuSelector)){return 0}var o=n.offset(),a={x:o.left,y:o.top-u.tolerance},l={x:o.left+n.outerWidth(),y:a.y},c={x:o.left,y:o.top+n.outerHeight()+u.tolerance},h={x:o.left+n.outerWidth(),y:c.y},p=i[i.length-1],d=i[0];if(!p){return 0}if(!d){d=p}if(d.x<o.left||d.x>h.x||d.y<o.top||d.y>h.y){return 0}if(s&&p.x==s.x&&p.y==s.y){return 0}var v=l,m=h;if(u.submenuDirection=="left"){v=c;m=a}else if(u.submenuDirection=="below"){v=h;m=c}else if(u.submenuDirection=="above"){v=a;m=l}var g=t(p,v),y=t(p,m),b=t(d,v),w=t(d,m);if(g<b&&y>w){s=p;return f}s=null;return 0};n.mouseleave(c).find(u.rowSelector).mouseenter(h).mouseleave(p).click(d);e(document).mousemove(l)}e.fn.menuAim=function(e){this.each(function(){t.call(this,e)});return this}})(jQuery);
